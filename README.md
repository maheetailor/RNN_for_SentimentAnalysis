...
During text preprocessing it was way too interesting as I had to do a lot of work like stemming, removing URLs, punctuations, stopwords and many more. I have also done encoding on sentiments + vectorization.
